...
main_menu = {1 => 'Создать станцию',
             ...
             9 => 'Получить список вагонов у поезда',
             10 => 'Добавить вагоны к поезду',
             11 => 'Загрузить вагон',
             12 => 'Разгрузить вагон',
             13 => 'Отцепить вагоны от поезда',
             14 => 'Просмотреть список станций и список поездов на станции',
             15 => 'Генерация тестовых объектов',
             0 => 'Завершение работы'
}
...
loop do
  ...
  when '7'
    ...
    # my_railroad.move_train_forward
  when '8'
